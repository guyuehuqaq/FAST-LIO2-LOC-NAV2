...
def generate_launch_description():
    ...
    map_file = '/home/jwhu/Projects/fast_lio_test_ws/src/data/test3.pcd'

    # 静态TF发布节点 - odom2camera_init
    static_tf_odom2camera_init = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='odom2camera_init',  # camera_init2odom
    ...
    # 增加 base_link2base_footprint
    static_tf_base_link2base_footprint = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
    ...
    global_localization_node = Node(
        ...
        remappings= [("/Odometry_loc" , "/Odometry"),
